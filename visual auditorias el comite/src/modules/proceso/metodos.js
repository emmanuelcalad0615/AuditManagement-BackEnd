...
export const traerID = async function(id){
    const respuesta = await fetch("http://3.143.204.151:5000/sector/getid/"+id, requestOptionsGet)
...
export const borrarID = async function(id){
    ...
    const respuesta = await fetch("http://3.143.204.151:5000/sector/delete/"+id, requestOptions)
        .then((response) => response.json());
...
export const guardarSector = async function(nombre){
  ...
  const respuesta = await fetch("http://3.143.204.151:5000/sector/save", requestOptionsPost)
    .then(response => response.json());
  return respuesta;
}
...
export const actualizarSector = async function(id, nombre){
  ...
  const respuesta = await fetch("http://3.143.204.151:5000/sector/update", requestOptions)
    .then(response => response.json());
  return respuesta;
}

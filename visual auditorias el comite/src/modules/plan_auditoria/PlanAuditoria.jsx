      ...
      {vista === 'principal' && (
        <section id="auditoria" className="seccion">
          <div
            ...
            className="flex  text-center justify-center flex-col bg-white rounded-2xl m-5"
          >
            <h2 className="titulo-tabla text-[#1E3766] text-xl">Planes de Auditoría</h2>
            <table>
